...
public class PredistedFallSystem : MonoBehaviour
{
    ...
    void Update()
    {
        cursor = FindObjectOfType<Pointer>().gameObject;
        LaunchProjectile();
    }
    ...
    void LaunchProjectile()
    {
            ...
            Vector3 vo = CalculateVelocty(cursor.transform.position, shootPoint.position, 1f);
